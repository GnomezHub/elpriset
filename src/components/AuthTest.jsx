        ...
        <>
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="flex items-center justify-center w-10 h-10 bg-white border border-gray-300 rounded-lg shadow-sm hover:bg-gray-50 hover:shadow-md hover:border-gray-400 active:bg-gray-100 transition-all duration-200"
            >
